...
theme.widget_startbtn                           = theme.confdir .. "/icons/awesome.png"
theme.widget_exit                               = theme.confdir .. "/icons/exit.png"
theme.widget_reboot                             = theme.confdir .. "/icons/reboot.png"
theme.widget_logout                             = theme.confdir .. "/icons/logout.png"
theme.widget_lock                               = theme.confdir .. "/icons/lock.png"
theme.widget_sleep                              = theme.confdir .. "/icons/sleep.png"
theme.widget_help                               = theme.confdir .. "/icons/help.png"
...
-- Startbutton
local myappsmenu = freedesktop.menu.build({
    before = {{ "Show Help", function() hotkeys_popup.show_help(nil, awful.screen.focused()) end, theme.widget_help }},
    after = {
        { "Lock", function() awful.util.spawn('betterlockscreen -l dim -- --time-str="%H:%M"') end, theme.widget_lock },
        { "Log out", function() awesome.quit() end, theme.widget_logout },
        { "Sleep", "systemctl suspend", theme.widget_sleep },
        { "Restart", "systemctl reboot", theme.widget_reboot },
        { "Shutdown", "systemctl poweroff", theme.widget_exit },
    }
})

local mylauncher = awful.widget.launcher({ image = theme.widget_startbtn,
                                     menu = myappsmenu })
