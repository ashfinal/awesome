...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" }, "x",  function () awful.util.spawn( "arcolinux-logout" ) end,
    ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn( filemanager ) end,
        {description = filemanager, group = "awesome"}),


    -- dmenu
    awful.key({ modkey, "Shift"   }, "d",
        function ()
            awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=12",
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "alacritty" ) end,
    ...
    awful.key({ "Control", "Shift"  }, "Print", function() awful.util.spawn("ksnip") end,
        {description = "ksnip screenshot", group = "screenshots"}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ modkey, altkey }, "y", function () lain.util.delete_tag() end,
    ...
    awful.key({ modkey, "Control"   }, "c", awful.placement.centered,
        {description = "center current window", group = "client"}),
